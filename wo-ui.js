...
function buildReceiptFooter(){
  ...
  function mount(){
    ...
    var meta=document.createElement('div');meta.className='mp-receipt-meta';meta.setAttribute('aria-hidden','true');meta.innerHTML='<span>SITE FOOTER</span><span>CUSTOMER: YOU</span>';receipt.appendChild(meta);
