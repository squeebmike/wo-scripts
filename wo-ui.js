...
function polishNavigation(){
  ...
  function wireDropdown(dropdown,index){
    ...
    function sync(){toggle.setAttribute('aria-expanded',String(list.classList.contains('w--open')));}sync();new MutationObserver(sync).observe(list,{attributes:true,attributeFilter:['class']});var timer;
